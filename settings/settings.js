...
export function registerSettings() {
  ...
  game.settings.register(moduleName, "combatantHidden", {
    ...
    default: "default",
    onChange: (value) => {
      tokensVisible.setupCombatantMasking(value);
    },
  });
  ...
  game.settings.register(moduleName, "pushhotkey", {
    ...
    default: "z",
    onChange: (value) => {
      tokensVisible.pushhotkey = value;
    },
  });
  ...
  game.settings.register(moduleName, "autopanningMargin", {
    ...
    default: "200",
    onChange: (value) => {
      tokensVisible.autopanMargin = value;
    },
  });
  ...
  game.settings.register(moduleName, "blindTokensControllable", {
    ...
    default: "Yes",
    onChange: (value) => {
      tokensVisible.blindControllable = value;
    },
  });
  ...
  game.settings.register(moduleName, "wallsCancelAnimation", {
    ...
    default: "Yes",
    onChange: (value) => {
      tokensVisible.wallsCancelAnimation = value;
    },
  });
  ...
  if (game.version != undefined && game.version >= 9) {
    ...
    game.settings.register(moduleName, "castRays", {
      ...
      default: "Standard",
      onChange: (value) => {
        tokensVisible.setProperCastRays(value);
      },
    });
    ...
    game.settings.register(moduleName, "castRayshotkey", {
      ...
      default: "e",
      onChange: (value) => {
        tokensVisible.castRayshotkey = value;
      },
    });
  }
  ...
  game.settings.register(moduleName, "sightCache", {
    ...
    default: game.version.substring(0, 4) == "0.7." ? "On" : "Off",
    onChange: (value) => {
      tokensVisible.setProperSightCache(value);
    },
  });
  ...
  game.settings.register(moduleName, "sightCachehotkey", {
    ...
    default: "E",
    onChange: (value) => {
      tokensVisible.sightCachehotkey = value;
    },
  });
}
